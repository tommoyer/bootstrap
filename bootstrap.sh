...
if [[ ${GNOME} == 1 ]]; then
  APT_PKGS+=" gir1.2-gda-5.0 gir1.2-gsound-1.0 gir1.2-gtop-2.0 gnome-shell-extension-manager gnome-tweaks wl-clipboard"
fi
